				...
				_level.getServer().getCommands().performCommand(
						...
						("title @a actionbar \"\u0130laca olan uzakl\u0131k: " + ""
								+ new java.text.DecimalFormat("##")
										.format(Math.hypot(XpequalsbrainModVariables.MapVariables.get(world).WitchX - entity.getX(),
												XpequalsbrainModVariables.MapVariables.get(world).WitchZ - entity.getZ()))
								+ "\""));
			if (Math.hypot(XpequalsbrainModVariables.MapVariables.get(world).WitchX - entity.getX(),
