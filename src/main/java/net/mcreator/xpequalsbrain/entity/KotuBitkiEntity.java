...
import net.mcreator.xpequalsbrain.procedures.KotuBitkiOnInitialEntitySpawnProcedure;
import net.mcreator.xpequalsbrain.procedures.KotuBitkiEntityDiesProcedure;
...
public class KotuBitkiEntity extends Monster {
	...
	public KotuBitkiEntity(EntityType<KotuBitkiEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(XpequalsbrainModItems.CANAVAR_OZU.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		KotuBitkiEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), source.getEntity());
	}
