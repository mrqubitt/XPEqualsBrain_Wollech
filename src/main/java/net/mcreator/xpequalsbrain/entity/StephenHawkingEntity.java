...
public class StephenHawkingEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(XpequalsbrainModEntities.STEPHEN_HAWKING.get(), 20, 4, 4));
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(XpequalsbrainModItems.DEHA_IQ.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(XpequalsbrainModEntities.STEPHEN_HAWKING.get(), SpawnPlacements.Type.ON_GROUND,
