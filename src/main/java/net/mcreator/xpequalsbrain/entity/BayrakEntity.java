...
public class BayrakEntity extends PathfinderMob {
	public BayrakEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(XpequalsbrainModEntities.BAYRAK.get(), world);
	}

	public BayrakEntity(EntityType<BayrakEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
