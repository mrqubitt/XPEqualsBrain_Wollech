 ...
 *
 */
package net.mcreator.xpequalsbrain;
...
@Mod("xpequalsbrain")
public class XpequalsbrainMod {
	public static final Logger LOGGER = LogManager.getLogger(XpequalsbrainMod.class);
	public static final String MODID = "xpequalsbrain";
