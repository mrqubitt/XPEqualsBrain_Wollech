...
public class EinsteinRenderer extends HumanoidMobRenderer<EinsteinEntity, HumanoidModel<EinsteinEntity>> {
	...
	public ResourceLocation getTextureLocation(EinsteinEntity entity) {
		return new ResourceLocation("xpequalsbrain:textures/entities/albert_einstein.png");
	}
}
