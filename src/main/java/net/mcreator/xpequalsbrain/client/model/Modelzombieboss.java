...
public class Modelzombieboss<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("xpequalsbrain", "modelzombieboss"), "main");
	public final ModelPart FullBody;
	public final ModelPart klsopa;
	public final ModelPart solbacak;
	public final ModelPart sabacak;
	public final ModelPart solkol;
	public final ModelPart sakol;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = FullBody.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 24).addBox(-8.0F, -8.2F, -2.0F, 16.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -24.0F, 0.0F));
		PartDefinition gvde = FullBody.addOrReplaceChild("gvde",
				CubeListBuilder.create().texOffs(0, 41).addBox(-7.4F, -20.6F, 5.6F, 15.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(64, 12)
		...
		PartDefinition cube_r1 = gvde.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(50, 47).addBox(-0.5F, -0.5F, 17.75F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 47)
		...
		PartDefinition cube_r2 = klsopa.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(32, 41).addBox(-1.35F, -5.45F, -1.95F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
		...
		PartDefinition cube_r3 = klsopa.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.5F, 9.5F, -11.0F, 1.0F, 1.0F, 23.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, -0.1572F, 0.3614F, -0.4215F));
		PartDefinition cube_r4 = klsopa.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(32, 41).addBox(-4.75F, 6.8F, -4.75F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
		...
		PartDefinition solbacak = partdefinition.addOrReplaceChild("solbacak",
				CubeListBuilder.create().texOffs(25, 0).addBox(2.05F, 17.747F, -7.3613F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(25, 0)
		...
		PartDefinition cube_r5 = solbacak.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 57).addBox(-3.0F, 0.0F, -4.6F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, -0.4014F, 0.0F, 0.0F));
		PartDefinition cube_r6 = solbacak.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(61, 59).addBox(-3.0F, -1.8F, -3.8F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = solbacak.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(25, 16).addBox(-3.0F, -9.15F, -3.5F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 43)
		...
		PartDefinition cube_r8 = solbacak.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(72, 24).addBox(-3.0F, -1.4F, -0.5F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = solbacak.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(48, 49).addBox(-3.0F, -2.0F, -5.0F, 6.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition sabacak = partdefinition.addOrReplaceChild("sabacak",
				CubeListBuilder.create().texOffs(25, 0).addBox(-2.95F, 17.747F, -7.3613F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(25, 0)
						.addBox(-1.2F, 17.747F, -7.3613F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(25, 0)
		...
		PartDefinition cube_r10 = sabacak.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 57).addBox(-3.0F, 0.0F, -4.6F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, -0.4014F, 0.0F, 0.0F));
		PartDefinition cube_r11 = sabacak.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(72, 24).addBox(4.0F, -1.4F, -0.5F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = sabacak.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(61, 59).addBox(-3.0F, -1.8F, -3.8F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.9637F, -4.4174F, 3.1241F, 0.0F, 0.0F));
		PartDefinition solkol = partdefinition.addOrReplaceChild(
				"solkol", CubeListBuilder.create().texOffs(63, 0).addBox(-5.5F, -3.0485F, -2.2029F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(37, 59).addBox(-6.1F, -3.3485F, -2.9029F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.9F, -5.4515F, 1.9029F));
		PartDefinition cube_r15 = solkol.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(58, 69).addBox(-25.5F, -1.0F, -1.25F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = solkol.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(68, 47).addBox(-25.05F, -1.5F, -2.75F, 5.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r17 = solkol.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(19, 65).addBox(-2.5F, 3.8F, -3.2F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = solparmaklar.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.2212F, -0.3186F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = solparmaklar.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.2212F, -1.6814F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = solparmaklar.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.3612F, -0.0983F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = solparmaklar.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.3612F, -1.9017F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition sakol = partdefinition.addOrReplaceChild(
				"sakol", CubeListBuilder.create().texOffs(63, 0).addBox(1.0F, -1.9351F, -1.9547F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(37, 59).addBox(0.4F, -2.2351F, -2.6547F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(7.6F, -6.5649F, 1.6547F));
		PartDefinition cube_r26 = sakol.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(58, 69).addBox(-2.5F, -1.0F, -1.25F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 5.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
		PartDefinition cube_r27 = sakol.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(68, 47).addBox(-2.0F, -1.5F, -2.75F, 5.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r29 = saparmaklar.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.5F, -0.3F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = saparmaklar.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r31 = saparmaklar.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.5F, 1.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r35 = saparmaklar.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition kafa = partdefinition.addOrReplaceChild("kafa",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.3F, -3.5F, -3.9F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r37 = kafa.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -0.6F, 0.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.6F, -1.5F, -3.9F, 0.384F, 0.0F, 0.0F));
		PartDefinition cube_r38 = kafa.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.6F, 0.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r40 = kafa.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(65, 36).addBox(3.5F, -2.0F, -4.65F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(65, 36)
						...
						.addBox(-3.5F, -2.0F, -5.4F, 7.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 16).addBox(-4.0F, -2.5F, -4.9F, 8.0F,
								5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0216F, 1.1548F, -0.1484F, 0.0F, 0.0F));
		PartDefinition cube_r41 = kafa.addOrReplaceChild("cube_r41",
				CubeListBuilder.create().texOffs(40, 33).addBox(-4.0F, -1.0F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r42 = dil.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.6F, -0.2017F, -2.25F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-1.0F, -0.2017F, -3.55F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(16, 0).addBox(-1.0F, -0.2017F, -2.55F,
								2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 3.1416F, 0.0F, 3.1241F));
		PartDefinition balta = kafa.addOrReplaceChild("balta",
				CubeListBuilder.create().texOffs(18, 3).addBox(-4.7145F, -0.0607F, 1.9892F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(18, 3).addBox(-5.0145F, -0.0607F, 1.1892F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 3)
