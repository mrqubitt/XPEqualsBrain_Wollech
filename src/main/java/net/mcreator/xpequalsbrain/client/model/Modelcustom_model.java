...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition
				.addOrReplaceChild(
						"bb_main", CubeListBuilder.create().texOffs(0, 9).addBox(-1.0F, -21.0F, 0.0F, 1.0F, 21.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(0.0F, -21.0F, 0.0F, 11.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
